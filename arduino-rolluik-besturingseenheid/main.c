...
int main()
{
	...
	SCH_Add_Task(check_light_intensity,0,300); // 300??
 	...
 	//send_index = SCH_Add_Task(add_temperature,0,750); // TODO: 0 toevoegen aan period
 	//mode_index = SCH_Add_Task(send_temperature_info,0,1500); // TODO: 0 toevoegen aan period
    // Handel taken af
    while (1) {
        SCH_Dispatch_Tasks();
    }
